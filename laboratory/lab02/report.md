...
subtitle: "Задача о погоне - вариант 8"
author: "Котиева Селима Сулеймановна НФИбд-02-18"
...
Через определенный промежуток времени туман рассеивается, и лодка обнаруживается на расстоянии 6.5 км от катера. 
